...
<div class='main-profile'>
	...
	<form class="" action="/escribecw" method="get">
	  ...
	  <div class="form-group">
        <input class="form-control" type="hidden" name="nombre_usuario" value="<?php echo $_SESSION['name'] . " " . $_SESSION['surname']; ?>" placeholder="Nombre usuario">
      </div>
      <div class="form-group">
	...
	<form class="" action="/modificacw" method="get">
	  ...
	  <div class="form-group">
        <input class="form-control" type="hidden" name="nombre_usuario" value="<?php echo $_SESSION['name'] . " " . $_SESSION['name']; ?>" placeholder="Nombre usuario">
      </div>
      <div class="form-group">
        <input class="form-control" type="text" name="nombre_prestador" value="" placeholder="Nombre prestador ">
      </div>
